...
\begin{table}[ht]
    ...
    \caption{
        ...
        errors are truncated to 3 significant figures. The errors are calculated
        from a standard deviation over trials.
        } % title of Table
\end{table}


The loading and saving speeds, as a function of file size, into memory by
